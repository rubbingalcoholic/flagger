...
exports.main = function (options, callbacks) {
	...
	var set_icon = function(hover)
	{
		...
		if (hover)
			if (flagger.get_is_active())
				widget.contentURL = data.url("images/flag_red_hover.png");
			else
				widget.contentURL = data.url("images/flag_gray_hover.png");
		else
			if (flagger.get_is_active())
				widget.contentURL = data.url("images/flag_red.png");
			else
				widget.contentURL = data.url("images/flag_gray.png");
	}
	...
	var widget = widgets.ToolbarWidget({
		...
		id: "open_flagger_btn",
		label: "Flagger",
		contentURL: data.url("images/flag_gray.png"),
